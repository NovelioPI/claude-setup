...
description: Use before you create or edit any file that an agent reads as instructions - a SKILL.md, CLAUDE.md, AGENTS.md, a file under ~/.claude/rules/, or a doc reached by a pointer from one of those. Read it before the first edit, not after.
---
